    ...
    async connect() {
        return new Promise((resolve, reject) => {
            try {
                ...
                reject(new PerpDEXError(`Failed to connect WebSocket: ${error instanceof Error ? error.message : String(error)}`, 'WS_CONNECTION_ERROR', 'paradex', error));
            }
        });
    }
    /**
    ...
    async *watchBalance() {
        ...
        try {
            ...
            while (true) {
                ...
                const normalized = balances.map((bal) => this.normalizer.normalizeBalance({
...
//# sourceMappingURL=ParadexWebSocketWrapper.js.map