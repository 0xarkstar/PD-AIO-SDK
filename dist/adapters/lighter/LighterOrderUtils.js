 ...
 */
export function toPriceUnits(price, tickSize) {
 ...
 */
export function fromPriceUnits(priceUnits, tickSize) {
 ...
 */
export function mapOrderTypeToString(type) {
    switch (type) {
 ...
 */
export function mapTimeInForce(tif, postOnly) {
    if (postOnly) {
 ...
 */
export function mapTimeInForceToString(tif) {
    switch (tif) {
 ...
 */
export function mapSideToLighter(side) {
    return side === 'buy' ? 1 : 2;
}
/**
 ...
 */
export function mapSideFromLighter(side) {
 ...
 */
export function calculateExpiration(ttlSeconds = 0) {
    if (ttlSeconds <= 0) {
 ...
 */
export function validateLighterOrder(request) {
    if (!request.symbol) {
...
//# sourceMappingURL=LighterOrderUtils.js.map