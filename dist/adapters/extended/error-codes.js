 ...
 */
export const EXTENDED_HTTP_ERROR_CODES = {
 ...
 */
export const EXTENDED_ERROR_MESSAGES = {
 ...
 */
export function extractErrorCodeFromStatus(status) {
    return EXTENDED_HTTP_ERROR_CODES[status] || 'UNKNOWN_ERROR';
}
/**
 * Map Extended error to unified PerpDEXError
 */
export function mapExtendedError(code, message, context) {
 ...
 */
export function mapStarkNetError(error) {
