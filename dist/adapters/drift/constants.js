 ...
 */
export const DRIFT_MARKET_INDEX_MAP = Object.entries(DRIFT_PERP_MARKETS).reduce((acc, [key, config]) => {
 ...
 */
export function unifiedToDrift(symbol) {
 ...
 */
export function driftToUnified(exchangeSymbol) {
 ...
 */
export function getMarketIndex(symbol) {
 ...
 */
export function getSymbolFromIndex(marketIndex) {
...
// Error Messages
// =============================================================================
export const DRIFT_ERROR_MESSAGES = {
