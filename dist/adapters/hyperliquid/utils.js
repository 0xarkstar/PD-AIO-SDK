 ...
 */
import { ExchangeUnavailableError, InsufficientMarginError, InvalidOrderError, InvalidSignatureError, OrderNotFoundError, PerpDEXError, PositionNotFoundError, RateLimitError, } from '../../types/errors.js';
 ...
 */
export function convertOrderRequest(request, exchangeSymbol) {
...
export function mapError(error) {
    ...
    if (error instanceof Error) {
        ...
        if (message.includes('503') || message.includes('502')) {
            return new ExchangeUnavailableError('Exchange temporarily unavailable', 'EXCHANGE_DOWN', 'hyperliquid', error);
        }
    }
