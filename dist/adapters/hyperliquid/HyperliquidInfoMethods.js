 ...
 */
export function parseUserFees(response) {
 ...
 */
export function parsePortfolio(response) {
 ...
 */
export function parseRateLimitStatus(response) {
...
//# sourceMappingURL=HyperliquidInfoMethods.js.map