...
export const ETHEREAL_ENDPOINT_WEIGHTS = {
    fetchMarkets: 1,
    fetchTicker: 1,
    fetchOrderBook: 2,
    fetchTrades: 1,
...
// Trading Constants
// =============================================================================
export const ETHEREAL_ORDER_TYPES = {
    market: 'MARKET',
    limit: 'LIMIT',
    stopMarket: 'STOP_MARKET',
    stopLimit: 'STOP_LIMIT',
};
export const ETHEREAL_ORDER_SIDES = {
    buy: 'BUY',
    sell: 'SELL',
};
export const ETHEREAL_TIME_IN_FORCE = {
    GTC: 'GTC',
    IOC: 'IOC',
    FOK: 'FOK',
    PO: 'POST_ONLY',
};
export const ETHEREAL_ORDER_STATUS = {
    NEW: 'open',
    OPEN: 'open',
...
export const ETHEREAL_KLINE_INTERVALS = {
    '1m': '1m',
    '5m': '5m',
    '15m': '15m',
    '30m': '30m',
 ...
 */
export function unifiedToEthereal(symbol) {
 ...
 */
export function etherealToUnified(exchangeSymbol) {
