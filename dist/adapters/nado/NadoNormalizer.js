    ...
    fromX18Safe(value) {
        try {
            ...
            if (!Number.isFinite(parsed)) {
                throw new PerpDEXError(`Invalid x18 value resulted in non-finite number: ${value}`, 'INVALID_NUMBER', 'nado');
            }
            ...
            throw new PerpDEXError(`Failed to convert from x18: ${value}`, 'CONVERSION_ERROR', 'nado', error);
        }
    }
    // ===========================================================================
