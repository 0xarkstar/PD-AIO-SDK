...
export class NadoAuth {
    ...
    async signOrder(order, productId) {
        try {
            ...
            throw new PerpDEXError(`Failed to sign order: ${error instanceof Error ? error.message : 'Unknown error'}`, 'SIGNING_FAILED', 'nado', error);
        }
    }
    /**
    ...
    async signCancellation(cancellation, endpointAddress) {
        try {
            ...
            throw new PerpDEXError(`Failed to sign cancellation: ${error instanceof Error ? error.message : 'Unknown error'}`, 'SIGNING_FAILED', 'nado', error);
        }
    }
    /**
    ...
    async signStreamAuth(streamAuth, endpointAddress) {
        try {
            ...
            throw new PerpDEXError(`Failed to sign stream auth: ${error instanceof Error ? error.message : 'Unknown error'}`, 'SIGNING_FAILED', 'nado', error);
        }
    }
    // ===========================================================================
    // Nonce Management
...
//# sourceMappingURL=NadoAuth.js.map