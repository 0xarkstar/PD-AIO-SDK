 ...
 */
export function productIdToVerifyingContract(productId) {
 ...
 */
export function nadoSymbolToCCXT(nadoSymbol, quoteAsset = 'USDT') {
 ...
 * @returns Nado symbol
 */
export function ccxtSymbolToNado(ccxtSymbol) {
 ...
 */
export function normalizeNadoProduct(product) {
 ...
 */
export function normalizeNadoOrder(order, productMapping) {
 ...
 */
export function normalizeNadoPosition(position, productMapping) {
 ...
 */
export function normalizeNadoBalance(balance) {
 ...
 */
export function normalizeNadoTrade(trade, productMapping) {
 ...
 */
export function normalizeNadoTicker(ticker) {
 ...
 */
export function normalizeNadoOrderBook(orderBook, symbol) {
    return {
        symbol,
 ...
 */
export function createNadoEIP712Domain(chainId, verifyingContract) {
    return {
 ...
 */
export async function signNadoOrder(wallet, order, chainId, productId) {
 ...
 */
export async function signNadoCancellation(wallet, cancellation, chainId, endpointAddress) {
 ...
 */
export async function signNadoStreamAuth(wallet, streamAuth, chainId, endpointAddress) {
    const domain = createNadoEIP712Domain(chainId, endpointAddress);
