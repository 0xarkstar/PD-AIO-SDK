 ...
 */
export const AVANTIS_PAIR_INDEX_MAP = {
    BTC: 0,
    ETH: 1,
    SOL: 2,
    DOGE: 3,
 ...
 */
export const AVANTIS_INDEX_TO_SYMBOL = Object.fromEntries(Object.entries(AVANTIS_PAIR_INDEX_MAP).map(([symbol, index]) => [index, symbol]));
/**
 * Convert unified symbol to Avantis pairIndex
 * @example "BTC/USD:USD" -> 0
 */
export function unifiedToAvantis(symbol) {
 ...
 */
export function avantisToUnified(pairIndex) {
