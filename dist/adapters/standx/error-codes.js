 ...
 */
import { AuthenticationError, BadRequestError, PerpDEXError, RateLimitError, } from '../../types/errors.js';
export const STANDX_ERROR_CODES = {
    400: 'BAD_REQUEST',
...
export function mapStandxError(code, message) {
    if (code === 429) {
...
export function mapStandxHttpError(status, message) {
