 ...
 */
export function parseBigInt(value, defaultValue = BigInt(0)) {
    if (value === null || value === undefined || value === '') {
        return defaultValue;
    }
    try {
 ...
 */
export function parseX18(value, decimals = 18) {
    if (value === null || value === undefined || value === '') {
        return 0;
    }
 ...
 */
export function formatX18(value, decimals = 18) {
 ...
 */
export function buildUnifiedSymbol(base, quote, settle) {
    if (settle) {
 ...
 */
export function extractBaseFromPerpSymbol(symbol) {
 ...
 */
export function mapOrderStatus(status, defaultStatus = 'open') {
 ...
 */
export function mapOrderType(type, defaultType = 'limit') {
 ...
 */
export function mapOrderSide(side) {
 ...
 */
export function mapTimeInForce(tif) {
    if (!tif)
        return 'GTC';
 ...
 */
export function roundToStepSize(amount, stepSize) {
 ...
 */
export function getDecimalPlaces(precision) {
    if (precision >= 1)
        return 0;
