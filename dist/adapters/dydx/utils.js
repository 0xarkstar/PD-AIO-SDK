 ...
 */
export function convertOrderRequest(request, subaccountNumber) {
 ...
 */
export function mapTimeframeToDydx(timeframe) {
    const mapping = {
        '1m': '1MIN',
        '5m': '5MINS',
        '15m': '15MINS',
 ...
 */
export function getDefaultOHLCVDuration(timeframe) {
    const durationMap = {
 ...
 */
export function getGoodTilTimeInSeconds(durationSeconds = 600) {
 ...
 */
export function buildSubaccountId(address, subaccountNumber) {
 ...
 */
export function parseSubaccountId(subaccountId) {
