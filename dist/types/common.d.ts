...
export declare const ORDER_STATUSES: readonly ["open", "closed", "canceled", "expired", "rejected", "filled", "partiallyFilled"];
...
export declare const MARGIN_MODES: readonly ["cross", "isolated"];
...
export declare const TRANSACTION_TYPES: readonly ["deposit", "withdrawal"];
export type TransactionType = (typeof TRANSACTION_TYPES)[number];
export declare const TRANSACTION_STATUSES: readonly ["pending", "processing", "completed", "failed", "canceled"];
 ...
 */
export declare const OHLCV_TIMEFRAMES: readonly ["1m", "3m", "5m", "15m", "30m", "1h", "2h", "4h", "6h", "8h", "12h", "1d", "3d", "1w", "1M"];
