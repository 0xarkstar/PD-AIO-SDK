 ...
 */
export declare function determineHealthStatus(apiReachable: boolean, wsConnected?: boolean, authValid?: boolean): HealthStatus;
/**
 * Check if health status is acceptable for operations
 */
export declare function isHealthy(status: HealthStatus): boolean;
/**
 * Check if health result indicates critical failure
 */
export declare function isCriticallyUnhealthy(result: HealthCheckResult): boolean;
