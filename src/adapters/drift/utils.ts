 ...
 */
export function priceToOnChain(price: number): string {
 ...
 */
export function priceFromOnChain(price: string | number): number {
 ...
 */
export function baseToOnChain(amount: number): string {
 ...
 */
export function baseFromOnChain(amount: string | number): number {
 ...
 */
export function quoteToOnChain(amount: number): string {
 ...
 */
export function quoteFromOnChain(amount: string | number): number {
  const a = typeof amount === 'string' ? parseFloat(amount) : amount;
 ...
 */
export function toDriftDirection(side: 'buy' | 'sell'): DriftDirection {
 ...
 */
export function fromDriftDirection(direction: DriftDirection): 'buy' | 'sell' {
 ...
 */
export function getPostOnlyParams(postOnly: boolean, slide?: boolean): DriftPostOnlyParams {
  if (!postOnly) return 'none';
 ...
 */
export function fundingRateFromOnChain(rate: string | number): number {
 ...
 */
export function annualizeFundingRate(hourlyRate: number): number {
...
export function buildHistoricalUrl(
  marketSymbol: string,
  dataType: 'trades' | 'funding' | 'candles',
  date: Date
): string {
 ...
 */
export function getNextFundingTimestamp(): number {
  const now = Date.now();
 ...
 */
export function getTimeUntilFunding(): number {
