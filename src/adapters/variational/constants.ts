...
export const VARIATIONAL_API_URLS = {
  mainnet: {
    rest: 'https://omni-client-api.prod.ap-northeast-1.variational.io', // ✅ Verified working
    websocket: 'NOT_AVAILABLE', // WebSocket not documented - will throw clear error
  },
  testnet: {
    rest: 'https://testnet.variational.io', // From official Python SDK
    websocket: 'NOT_AVAILABLE', // WebSocket not documented
  },
} as const;
 ...
 */
export const VARIATIONAL_ORDER_TYPES = ['market', 'limit', 'rfq'] as const;

/**
 * Order sides
 */
export const VARIATIONAL_ORDER_SIDES = ['buy', 'sell'] as const;
 ...
 * Position sides
 */
export const VARIATIONAL_POSITION_SIDES = ['long', 'short'] as const;
...
export const VARIATIONAL_DEFAULTS = {
  ...
  rateLimitTier: 'default' as const,
  orderBookDepth: 50,
  tradesLimit: 100,
