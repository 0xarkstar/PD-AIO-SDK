...
export function mapGRVTError(
  ...
  if (
    code === GRVT_CLIENT_ERRORS.INVALID_SIGNATURE ||
  ...
  if (
    code === GRVT_CLIENT_ERRORS.INSUFFICIENT_MARGIN ||
  ...
  if (
    code === GRVT_CLIENT_ERRORS.INVALID_ORDER ||
 ...
 */
export function extractGRVTError(response: any): {
  code: string;
  message: string;
} {
