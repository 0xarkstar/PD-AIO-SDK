 ...
 */
export function lighterParseMessage(data: unknown): WebSocketMessage {
  const parsed = (typeof data === 'string' ? JSON.parse(data) : data) as LighterFrame;
 ...
 */
export function lighterResolveKeys(
