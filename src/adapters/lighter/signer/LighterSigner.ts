 ...
 */
function findLibraryPath(customPath?: string): string {
  if (customPath) {
...
export class LighterSigner {
  ...
  private nativeLib: any = null;
  private functions: {
    CreateClient?: any;
    SignCreateOrder?: any;
    SignCancelOrder?: any;
    SignCancelAllOrders?: any;
    SignWithdraw?: any;
    CreateAuthToken?: any;
  } = {};
  ...
  private SignedTxResponseType: any = null;
  private StrOrErrType: any = null;
  ...
  async initialize(): Promise<void> {
    ...
    try {
      ...
      this.functions.CreateClient = this.nativeLib.func(
        'char * CreateClient(char *, char *, int, int, int64)'
      );

      // SignedTxResponse SignCreateOrder(int, long long, long long, int, int, int, int, int, int, long long, long long, int, long long)
      this.functions.SignCreateOrder = this.nativeLib.func(
        'SignedTxResponse SignCreateOrder(int, int64, int64, int, int, int, int, int, int, int64, int64, int, int64)'
      );
      ...
      this.functions.SignCancelOrder = this.nativeLib.func(
        'SignedTxResponse SignCancelOrder(int, int64, int64, int, int64)'
      );
      ...
      this.functions.SignCancelAllOrders = this.nativeLib.func(
        'SignedTxResponse SignCancelAllOrders(int, int64, int64, int, int64)'
      );
      ...
      this.functions.SignWithdraw = this.nativeLib.func(
        'SignedTxResponse SignWithdraw(int, int, uint64, int64, int, int64)'
      );

      // StrOrErr CreateAuthToken(long long cDeadline, int cApiKeyIndex, long long cAccountIndex)
      this.functions.CreateAuthToken = this.nativeLib.func(
        'StrOrErr CreateAuthToken(int64, int, int64)'
      );
  ...
  async signCreateOrder(params: CreateOrderParams): Promise<SignedTx> {
    ...
    const response = this.functions.SignCreateOrder!(
      params.marketIndex,
      BigInt(params.clientOrderIndex),
  ...
  async signCancelOrder(params: CancelOrderParams): Promise<SignedTx> {
    ...
    const response = this.functions.SignCancelOrder!(
      params.marketIndex,
  ...
  async createAuthToken(expirySeconds = 3600): Promise<string> {
    ...
    const response = this.functions.CreateAuthToken!(
      deadline,
      this.config.apiKeyIndex,
      BigInt(this.config.accountIndex)
    );
