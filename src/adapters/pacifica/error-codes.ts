...
export const PACIFICA_ERROR_CODES: Record<string, string> = {
...
export function isRetryableError(code: string): boolean {
  return (
    code === 'RATE_LIMIT_EXCEEDED' || code === 'SERVICE_UNAVAILABLE' || code === 'INTERNAL_ERROR'
  );
}

export function mapPacificaError(code: string, message: string): PerpDEXError {
  switch (code) {
