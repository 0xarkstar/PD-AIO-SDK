 ...
 */
export function unifiedToDydx(symbol: string): string {
 ...
 */
export function dydxToUnified(exchangeSymbol: string): string {
  // dYdX format: "BTC-USD"
...
export const DYDX_ERROR_MESSAGES: Record<string, string> = {
